...
en.data = {
    ...
    NAV_AddWallet: 'Lägg till en plånbok',
    NAV_GenerateWallet: 'Generera en plånbok',
    NAV_BulkGenerate: 'Generera flera plånböcker',
    NAV_SendEther: 'Skicka Ether',
    NAV_SendTokens: 'Skicka Tokens',
    NAV_Offline: 'Skicka offline',
    NAV_WithdrawDAO: 'Ta tillbaka DAO',
    DAO_TitleLong: 'Ta tillbaka dina Dao-tokens i ETH',
    NAV_ClaimDGD: 'Kräv DGD',
    DGD_TitleLong: 'Gör anspråk på dina DGD-tokens',
